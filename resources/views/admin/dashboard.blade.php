                ...
                <div class="content-wrapper pb-0">
                    <div class="page-header flex-wrap">
                        ...
                        <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
                            ...
                            <button type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                                <i class="mdi mdi-plus-circle"></i> Tambah data Pariwisata & HomeStay </button>
                        </div>
                    </div>
                                        ...
                                        <div>
                                            <div
                                                ...
                                                <div class="d-flex mr-5">
                                                    ...
                                                    <div class="pl-2">
                                                        <h4 class="mb-0 font-weight-semibold head-count"> 14 Unit </h4>
                                                        <span class="font-10 font-weight-semibold text-muted">Total Homestay Tersewa </span>
                                                    </div>
                                                </div>
                                                <div class="d-flex mr-3 mt-2 mt-sm-0">
                                                    ...
                                                    <div class="pl-2">
                                                        <h4 class="mb-0 font-weight-semibold head-count"> Rp 13.053.321 </h4>
                                                        <span class="font-10 font-weight-semibold text-muted">Total Keuntungan</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100" src="assets-admin/images/dashboard/img_1.jpg"
                                        alt="" />
                                </div>
                        ...
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100" src="assets-admin/images/dashboard/img_2.jpg"
                                        alt="" />
                                </div>
                                <div class="card-body px-3 text-dark">
                                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100" src="assets-admin/images/dashboard/img_3.jpg"
                                        alt="" />
                                </div>
                                <div class="card-body px-3 text-dark">
                                    <div class="d-flex justify-content-between">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table custom-table text-dark">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="assets-admin/images/faces/face2.jpg" class="mr-2"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="assets-admin/images/faces/face3.jpg" class="mr-2"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="assets-admin/images/faces/face4.jpg" class="mr-2"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="assets-admin/images/faces/face5.jpg" class="mr-2"
                                                            alt="image" /> Ina Curry
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="assets-admin/images/faces/face7.jpg" class="mr-2"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="assets-admin/images/faces/face9.jpg" class="mr-2"
                            ...
                            <div class="card color-card-wrapper">
                                <div class="card-body">
                                    <img class="img-fluid card-top-img w-100"
                                        src="assets-admin/images/dashboard/img_5.jpg" alt="" />
