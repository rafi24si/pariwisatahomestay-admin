    ...
    <div class="container mt-5">
        <div class="card shadow-lg border-0 rounded-4 animate__animated animate__fadeInUp gradient-card">
            ...
            <div class="card-body bg-light animate__animated animate__fadeIn">
                        ...
                        <tbody>
                            @forelse($data as $index => $item)
                                <tr class="animate__animated animate__fadeInUp">
                                    ...
                                    <td>
                                        @if ($item->media)
                                            <img src="{{ asset('storage/' . $item->media) }}" width="70"
                                                class="rounded shadow-sm border border-2 border-light">
                                        @else
                                    ...
                                    <td>
                                        <a href="{{ route('destinasi.edit', $item->destinasi_id) }}"
                                            class="btn btn-outline-primary btn-sm rounded-pill hover-zoom">
                                        ...
                                        <form action="{{ route('destinasi.destroy', $item->destinasi_id) }}" method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="button"
                                                class="btn btn-danger btn-sm rounded-pill hover-zoom btn-delete">
                ...
                <!-- PAGINATION DI BAWAH, POSISI KIRI -->
